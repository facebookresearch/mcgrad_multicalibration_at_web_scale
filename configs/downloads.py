REQUIRED_FILES = {
    ...
    'HMDA': [
        '2017-TX-features.csv',
        '2017-TX-target.csv',
        '2017-TX-protected.csv',
    ],
    'MEPS': [
        'meps_train_processed.csv',
        'meps_test_processed.csv',
        'mepsdata_train_labels.txt',
        'mepsdata_test_labels.txt',
    ],
}
...
REQUIRED_FILE_URLS = {
    ...
    'HMDA': [
        'https://github.com/pasta41/hmda-data-2017/raw/main/2017/TX/2017-TX-features.zip',
        'https://github.com/pasta41/hmda-data-2017/raw/main/2017/TX/2017-TX-protected.zip',
        'https://github.com/pasta41/hmda-data-2017/raw/main/2017/TX/2017-TX-target.zip'
    ],
    'MEPS': [
        'https://raw.githubusercontent.com/alangee/FaiR-N/master/datasets/meps/meps_train_processed.csv',
        'https://raw.githubusercontent.com/alangee/FaiR-N/master/datasets/meps/meps_test_processed.csv',
        'https://raw.githubusercontent.com/alangee/FaiR-N/master/datasets/meps/mepsdata_train_labels.txt',
        'https://raw.githubusercontent.com/alangee/FaiR-N/master/datasets/meps/mepsdata_test_labels.txt',
    ]
}
...
def req_urls(dataset):
    return REQUIRED_FILE_URLS[dataset]